...
## 已完成（截至 2026-05-22，v0.2.8）

| 优先级 | 功能 | 状态 |
|--------|------|------|
| UI | Wiki 标签栏重设计（折叠/Top-15/AND-OR 开关/多标签 Bug 修复/AI新建按钮升级） | ✅ commits `c331f82`–`a2de4f1` |
| UI | 侧边栏图标与标签全面梳理（6 个模块图标更新，Agent Studio→Agent，MCP 市场→MCP） | ✅ commits `f658846`–`d5e4571` |
| chore | tauri.conf.json 版本从遗漏的 0.2.6 补齐至 0.2.8 | ✅ |
