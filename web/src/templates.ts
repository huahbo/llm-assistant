...
export const researchTemplate: WikiTemplate = {
  id: "research",
  name: "研究 (Research)",
  description: "深度研究，支持假设跟踪和方法论笔记",
  icon: "🔬",
...
export const readingTemplate: WikiTemplate = {
  id: "reading",
  name: "阅读 (Reading)",
  description: "跟踪书籍人物、主题、情节和章节笔记",
  icon: "📚",
...
export const personalTemplate: WikiTemplate = {
  id: "personal",
  name: "个人成长 (Personal Growth)",
  description: "跟踪目标、习惯、反思和成长日志",
  icon: "🌱",
...
export const businessTemplate: WikiTemplate = {
  id: "business",
  name: "业务/团队 (Business)",
  description: "管理会议、决策、项目和干系人背景",
  icon: "💼",
...
export const generalTemplate: WikiTemplate = {
  id: "general",
  name: "通用 (General)",
  description: "极简设置 — 适用于任何目的的空白模板",
  icon: "📄",
  extraDirs: [],
  schema: `# Wiki Schema
