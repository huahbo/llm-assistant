...
// ── Re-exports for backward compatibility (modules + tests import from here) ──
...
// wiki-utils re-exports
export type {
  WikiLineDiffKind,
  WikiLineDiffRow,
  WikiHighlightSegment,
  WikiSortMode,
  WikiTreeNode,
  WikiAutocompleteMatch,
} from "./wiki-utils";
export {
  simpleHash,
...
export type { LintIssueGroup } from "./wiki-utils";

// ask-utils re-exports
export type { DropMode, QueryProgressUpdate } from "./ask-utils";
export {
  OCR_PROVIDER_STORAGE_KEY,
  ASK_SEARCH_DEBUG_VISIBLE_STORAGE_KEY,
  DROP_MODE_STORAGE_KEY,
  QUERY_HISTORY_STORAGE_KEY,
  QUERY_HISTORY_MAX,
  isDropMode,
  readDropModeFromStorage,
  writeDropModeToStorage,
...
// ingest-utils re-exports
export type { DroppedIngestPathsResult, TemplateInitPreview } from "./ingest-utils";
export {
  defaultIngestSourcePath,
  defaultIngestPdfPath,
  defaultIngestFilePath,
  defaultIngestFileOcrProvider,
  ingestSupportedFileExtensions,
  normalizeTemplateDirPath,
  buildTemplateInitPreview,
  parseDroppedIngestPaths,
  formatPdfIngestErrorMessage,
} from "./ingest-utils";

// ── Local imports from re-exported utilities (used by App function) ──
import { readDropModeFromStorage, writeDropModeToStorage, type DropMode } from "./ask-utils";

// ── App-local constants (used only within this module) ──
